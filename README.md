...
-   Removed the previous 2000-row / 2000-time-segment limits. The timeline now only draws the cards and time segments currently in or near view, so much larger datasets can be displayed without the mod erroring out or slowing down.
